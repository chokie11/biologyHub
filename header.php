...
:root {
  ...
  :root { 
    --background-color: rgb(238, 244, 252); /* Background color for the entire website, including individual sections */
...
body {
  ...
  /* BACKGROUND IMAGE */
  background: rgb(236, 240, 251); /* adjust path */
...
@media (min-width: 1200px) {
  ...
  .mobile-auth .signup-link {
    background: white;
    color: #3960a2;
    border-radius: 8px;
    margin: 5px 10px;
    padding: 10px;
    border: 2px solid #3960a2 ;
...
.buttonHero button.getStarted{
      background: radial-gradient( 100% 100% at 100% 0%, #e77822 0%, #df6406 100% );
...
.buttonHero  button.getStarted:active {
  box-shadow: inset 0px 0.1em 0.6em #fa8831;
